...
public class Filter_Mexico_Country extends NavigateToEmployeeDirectoryPage 

{
	...
	public void Clear() throws IOException
	{
		...
		new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(e.CountryFilter()));
		...
		{
			if(col.get(i).getText().equals("Mexico"))
			{
