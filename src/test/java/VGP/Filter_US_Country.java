...
public class Filter_US_Country extends NavigateToEmployeeDirectoryPage 

{
	...
	public void Clear() throws IOException
	{
		...
		new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(e.CountryFilter()));
		...
		{
			if(col.get(i).getText().equals("United States"))
			{
